...
<ul class="sub-menu">
    ...
    <li class="nav-item ">
        <a href="{{route('ref.index')}}" class="nav-link ">
            <span class="title">المرجع</span>
        </a>
    </li>
    <li class="nav-item ">
        <a href="{{route('attch.index')}}" class="nav-link ">
            <span class="title">الملفات</span>
        </a>
    </li>
    <li class="nav-item ">
        <a href="{{route('guids.index')}}" class="nav-link ">
...
<li class="nav-item ">
 ...
 <li class="nav-item ">
        <a href="{{route('notfy.index')}}" class="nav-link ">
            <span class="title">المتقدمين للوظائف</span>
        </a>
    </li>
</ul>
</li>
