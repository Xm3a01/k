  ...
  <div class="container  justify-content-center " role="document">
    <div class=" row  justify-content-center ">
     <div class="col-md-4 shadow1 mb-5  bg-white">
        ...
        <div class="py-2 ">  
          <form  method="POST" action="{{route('owners.register.submit',app()->getLocale())}}" class="p-2 " id="app"  autocomplete="off">
            @csrf
        <div class="form-row">
                    ...
                    <label for="name" > {{ __('First Name') }} </label>
                        ...
                        <div class="form-group col-md-12">
                            <label for="phone" > {{ __('Last Name') }} </label>
                                    ...
                                    <input id="last_name" type="text" class="form-control @error('last_name') is-invalidphone @enderror" name="last_name" value="{{ old('last_name') }}" required autocomplete="last_name" autofocus>
